...
<head>
    ...
    <link rel="icon" href="../images/sayu).png">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="<?=base_url('assets/');?>index2.html" class="logo">
                ...
                <span class="logo-mini" img><img class="logo" src="../images/sayu).png" alt="" weight="40" height="28"></span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="user_password">Password Baru<span class="text-red">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="user_password">Konfirmasi Password Baru<span class="text-red">*</span></label>
                                        <input type="hidden" name="id">
                                        <input type="hidden" name="url">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; <?=date('Y');?> <a href="https://http://www.sman1indramayu.sch.id/">e-Academic</a>.</strong>
            All rights reserved. 
        </footer>
    </div>
    <!-- ./wrapper -->
